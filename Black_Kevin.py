...
#General Module
    ...
    if message.content.find("sh.help") != -1:
        ...
        embed.add_field(name="pat", value="1", inline=True)
        embed.add_field(name="baka", value="2", inline=True)
        embed.add_field(name="hug", value="3", inline=True)
        embed.add_field(name="lick", value="4", inline=True)
        embed.add_field(name="slap", value="5", inline=True)
        embed.add_field(name="kiss", value="6", inline=True)
        ...
        embed.add_field(name="lewd", value="14", inline=True)
        embed.add_field(name="dance", value="15 - Pues... bailas, busca el baile secreto (y si se te ocurre alguno comentalo)", inline=True)
        embed.add_field(name="jojo", value="16", inline=True)
